...
--
-- Name: network_translations; Type: TABLE; Schema: :SCH; Owner: chouette; Tablespace:
--
...
(
    ...
    CONSTRAINT network_translations_network_fkey FOREIGN KEY (network_id) REFERENCES networks (id) ON DELETE CASCADE
);


ALTER TABLE :SCH.network_translations OWNER TO chouette;
...
ALTER TABLE :SCH.network_translations_id_seq OWNER TO chouette;
ALTER SEQUENCE network_translations_id_seq OWNED BY network_translations.id;

--
-- Name: company_translations; Type: TABLE; Schema: :SCH; Owner: chouette; Tablespace:
--
...
(
    ...
    CONSTRAINT company_translations_company_fkey FOREIGN KEY (company_id) REFERENCES companies (id) ON DELETE CASCADE
);


ALTER TABLE :SCH.company_translations OWNER TO chouette;
...
ALTER TABLE :SCH.company_translations_id_seq OWNER TO chouette;
ALTER SEQUENCE company_translations_id_seq OWNED BY company_translations.id;

--
-- Name: line_translations; Type: TABLE; Schema: :SCH; Owner: chouette; Tablespace:
--
...
(
    ...
    CONSTRAINT line_translations_line_fkey FOREIGN KEY (line_id) REFERENCES lines (id) ON DELETE CASCADE
);


ALTER TABLE :SCH.line_translations OWNER TO chouette;
...
ALTER TABLE :SCH.line_translations_id_seq OWNER TO chouette;
ALTER SEQUENCE line_translations_id_seq OWNED BY line_translations.id;

--
-- Name: stop_area_translations; Type: TABLE; Schema: :SCH; Owner: chouette; Tablespace:
--
...
(
    ...
    CONSTRAINT stop_area_translations_stop_area_fkey FOREIGN KEY (stop_area_id) REFERENCES stop_areas (id) ON DELETE CASCADE
);


ALTER TABLE :SCH.stop_area_translations OWNER TO chouette;
...
ALTER TABLE :SCH.stop_area_translations_id_seq OWNER TO chouette;
ALTER SEQUENCE stop_area_translations_id_seq OWNED BY stop_area_translations.id;

--
-- Name: vehicle_journey_translations; Type: TABLE; Schema: :SCH; Owner: chouette; Tablespace:
--
...
(
    ...
    CONSTRAINT vehicle_journey_translations_vj_fkey FOREIGN KEY (vehicle_journey_id) REFERENCES vehicle_journeys (id) ON DELETE CASCADE
);


ALTER TABLE :SCH.vehicle_journey_translations OWNER TO chouette;
...
ALTER TABLE :SCH.vehicle_journey_translations_id_seq OWNER TO chouette;
...
(
    ...
    CONSTRAINT vehicle_journey_at_stop_translations_vjas_fkey FOREIGN KEY (vehicle_journey_at_stop_id) REFERENCES vehicle_journey_at_stops (id) ON DELETE CASCADE
);


ALTER TABLE :SCH.vehicle_journey_at_stop_translations OWNER TO chouette;
...
ALTER TABLE :SCH.vehicle_journey_at_stop_translations_id_seq OWNER TO chouette;
