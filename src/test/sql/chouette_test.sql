...
--
-- Name: get_empty_scheduled_stop_points(); Type: FUNCTION; Schema: public; Owner: chouette
--

CREATE FUNCTION public.get_empty_scheduled_stop_points() RETURNS text
    LANGUAGE plpgsql
AS $$
declare
    tempRow record;
...
begin
    ...
    FOR tempRow IN select * from public.referentials where NOT (slug like 'rb_%') order by slug LOOP
            EXECUTE 'SELECT count(*) FROM (select * from ' || tempRow.slug
                || '.scheduled_stop_points ssp where ssp.stop_area_objectid_key is  null ) as sub'
                INTO numNulls;

            RAISE NOTICE USING MESSAGE  = tempRow.slug || ',' || numNulls || E'\n';
        END LOOP;
    return result;
end; $$;


ALTER FUNCTION public.get_empty_scheduled_stop_points() OWNER TO chouette;
...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: public; Owner: chouette
--
...
ALTER TABLE public.ar_internal_metadata OWNER TO chouette;
...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: chouette_gui; Owner: chouette
--

CREATE TABLE chouette_gui.ar_internal_metadata (
                                                   key character varying NOT NULL,
                                                   value character varying,
                                                   created_at timestamp without time zone NOT NULL,
                                                   updated_at timestamp without time zone NOT NULL
...
ALTER TABLE chouette_gui.ar_internal_metadata OWNER TO chouette;
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: chouette
--
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: chouette_gui; Owner: chouette
--

ALTER TABLE ONLY chouette_gui.ar_internal_metadata
    ADD CONSTRAINT ar_internal_metadata_pkey PRIMARY KEY (key);
...
--
-- Name: dated_service_journeys_vehicle_journey_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX dated_service_journeys_vehicle_journey_id_idx ON public.dated_service_journeys USING btree (vehicle_journey_id);
...
--
-- Name: footnotes_vehicle_journeys_footnote_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX footnotes_vehicle_journeys_footnote_id_idx ON public.footnotes_vehicle_journeys USING btree (footnote_id);


--
-- Name: footnotes_vehicle_journeys_vehicle_journey_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX footnotes_vehicle_journeys_vehicle_journey_id_idx ON public.footnotes_vehicle_journeys USING btree (vehicle_journey_id);
...
--
-- Name: interchanges_to_vehicle_journey_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX interchanges_to_vehicle_journey_idx ON public.interchanges USING btree (to_vehicle_journey);
...
--
-- Name: routes_route_points_route_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX routes_route_points_route_id_idx ON public.routes_route_points USING btree (route_id);


--
-- Name: routes_route_points_route_point_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX routes_route_points_route_point_id_idx ON public.routes_route_points USING btree (route_point_id);
...
--
-- Name: stop_points_route_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX stop_points_route_id_idx ON public.stop_points USING btree (route_id);


--
-- Name: stop_points_scheduled_stop_point_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX stop_points_scheduled_stop_point_id_idx ON public.stop_points USING btree (scheduled_stop_point_id);
...
--
-- Name: vehicle_journeys_journey_pattern_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX vehicle_journeys_journey_pattern_id_idx ON public.vehicle_journeys USING btree (journey_pattern_id);


--
-- Name: vehicle_journeys_key_values_vehicle_journey_id_idx; Type: INDEX; Schema: public; Owner: chouette
--

CREATE INDEX vehicle_journeys_key_values_vehicle_journey_id_idx ON public.vehicle_journeys_key_values USING btree (vehicle_journey_id);
...
--
-- Name: dated_service_journeys_vehicle_journey_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX dated_service_journeys_vehicle_journey_id_idx ON chouette_gui.dated_service_journeys USING btree (vehicle_journey_id);
...
--
-- Name: footnotes_vehicle_journeys_footnote_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX footnotes_vehicle_journeys_footnote_id_idx ON chouette_gui.footnotes_vehicle_journeys USING btree (footnote_id);


--
-- Name: footnotes_vehicle_journeys_vehicle_journey_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX footnotes_vehicle_journeys_vehicle_journey_id_idx ON chouette_gui.footnotes_vehicle_journeys USING btree (vehicle_journey_id);
...
--
-- Name: interchanges_to_vehicle_journey_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX interchanges_to_vehicle_journey_idx ON chouette_gui.interchanges USING btree (to_vehicle_journey);
...
--
-- Name: routes_route_points_route_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX routes_route_points_route_id_idx ON chouette_gui.routes_route_points USING btree (route_id);


--
-- Name: routes_route_points_route_point_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX routes_route_points_route_point_id_idx ON chouette_gui.routes_route_points USING btree (route_point_id);
...
--
-- Name: stop_points_route_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX stop_points_route_id_idx ON chouette_gui.stop_points USING btree (route_id);


--
-- Name: stop_points_scheduled_stop_point_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX stop_points_scheduled_stop_point_id_idx ON chouette_gui.stop_points USING btree (scheduled_stop_point_id);
...
--
-- Name: vehicle_journeys_journey_pattern_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX vehicle_journeys_journey_pattern_id_idx ON chouette_gui.vehicle_journeys USING btree (journey_pattern_id);


--
-- Name: vehicle_journeys_key_values_vehicle_journey_id_idx; Type: INDEX; Schema: chouette_gui; Owner: chouette
--

CREATE INDEX vehicle_journeys_key_values_vehicle_journey_id_idx ON chouette_gui.vehicle_journeys_key_values USING btree (vehicle_journey_id);
...
insert into public.referential_last_update(id, last_update_timestamp) values(1, current_timestamp);
