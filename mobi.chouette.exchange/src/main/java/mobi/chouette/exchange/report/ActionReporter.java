...
public interface ActionReporter {
	...
	enum OBJECT_TYPE {
		NETWORK, COMPANY, STOP_AREA, STOP_AREA_NEW, STOP_POINT, STOP_POINT_NEW, CONNECTION_LINK, ACCESS_POINT, TIMETABLE, LINE, ROUTE, ROUTE_SECTION, JOURNEY_PATTERN, VEHICLE_JOURNEY, INTERCHANGE, FARE_ATTRIBUTE, FARE_RULE, TRANSLATION
	}
