...
public class TransfersUpdater implements Updater<Transfers> {
	...
	public void update(Context context, Transfers oldValue, Transfers newValue) throws Exception {
		...
		if (oldValue.isDetached()) {
			...
			oldValue.setFromLine(newValue.getFromLine());
			oldValue.setToLine(newValue.getToLine());
			...
			if (newValue.getFromLine() != null && !newValue.getFromLine().equals(oldValue.getFromLine())) {
				oldValue.setFromLine(newValue.getFromLine());
			}
			if (newValue.getToLine() != null && !newValue.getToLine().equals(oldValue.getToLine())) {
				oldValue.setToLine(newValue.getToLine());
			}
