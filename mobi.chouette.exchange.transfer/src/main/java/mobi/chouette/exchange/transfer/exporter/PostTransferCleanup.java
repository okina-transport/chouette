...
public class PostTransferCleanup implements Command, Constant {
    ...
    private static final String REMOVE_DELETED_LINES_FUNCTION_NAME = "remove_deleted_lines";
    private static final String REMOVE_DELETED_ROUTES_FUNCTION_NAME = "remove_deleted_routes";
    private static final String REMOVE_DELETED_JOURNEY_PATTERNS_FUNCTION_NAME = "remove_deleted_journey_patterns";
    private static final String REMOVE_EMPTY_JOURNEY_PATTERNS_FUNCTION_NAME = "remove_empty_journey_patterns";
    private static final String REMOVE_EMPTY_ROUTES_FUNCTION_NAME = "remove_empty_routes";
    private static final String REMOVE_INCORRECT_JOURNEY_PATTERNS_FUNCTION_NAME = "remove_incorrect_journey_patterns";
    private static final String REMOVE_INCORRECT_ROUTES_FUNCTION_NAME = "remove_incorrect_routes";
    private static final String REFRESH_DEPARTURE_ARRIVALS_FUNCTION_NAME = "refresh_departure_arrivals";
    private static final String REMOVE_INCORRECT_VEHICLE_JOURNEYS_FUNCTION_NAME = "remove_incorrect_vehicle_journeys";
    private static final String REMOVE_EMPTY_TIME_TABLES_FUNCTION_NAME = "remove_empty_time_tables";
    private static final String REMOVE_VJ_WITH_NO_TT_FUNCTION_NAME = "remove_vehicle_journey_with_no_time_tables";
    private static final String REMOVE_EMPTY_LINES_FUNCTION_NAME = "remove_empty_lines";
    private static final String REORG_PERIODS_FUNCTION_NAME = "reorg_time_table_periods";
    private static final String REMOVE_UNUSED_STOPS = "remove_unused_stops";
    ...
    public boolean execute(Context context) throws Exception {
        ...
        LocalDate startDate = configuration.getStartDate() == null ? LocalDate.now() : TimeUtil.toLocalDate(configuration.getStartDate());
        LocalDate endDate = configuration.getEndDate() == null ? LocalDate.now() : TimeUtil.toLocalDate(configuration.getEndDate());
