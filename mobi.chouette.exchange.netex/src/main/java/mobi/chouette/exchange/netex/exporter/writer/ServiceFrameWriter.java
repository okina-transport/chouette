...
public class ServiceFrameWriter extends AbstractWriter{
	...
	public static void write(Writer writer, ExportableData data ) throws IOException, DatatypeConfigurationException 
	{
		...
		writer.write("  <Network version=\""+network.getObjectVersion()+"\" changed=\""+line.getNetwork().getVersionDate().format(format)+"\" \n");
		...
		writer.write("       <DefaultDuration>"+durationFactory.newDuration(connectionLink.getDefaultDuration().get(ChronoUnit.MILLIS))+"</DefaultDuration>\n");
		//        #end
		//        #if ( $connectionLink.frequentTravellerDuration)
		if (isSet(connectionLink.getFrequentTravellerDuration())) 
		writer.write("        <FrequentTravellerDuration>"+durationFactory.newDuration(connectionLink.getFrequentTravellerDuration().get(ChronoUnit.MILLIS))+"</FrequentTravellerDuration>\n");
		//        #end
		//        #if ( $connectionLink.occasionalTravellerDuration)
		if (isSet(connectionLink.getOccasionalTravellerDuration())) 
		writer.write("        <OccasionalTravellerDuration>"+durationFactory.newDuration(connectionLink.getOccasionalTravellerDuration().get(ChronoUnit.MILLIS))+"</OccasionalTravellerDuration>\n");
		//        #end
		//        #if ( $connectionLink.mobilityRestrictedTravellerDuration)
		if (isSet(connectionLink.getMobilityRestrictedTravellerDuration())) 
		writer.write("        <MobilityRestrictedTravellerDuration>"+durationFactory.newDuration(connectionLink.getMobilityRestrictedTravellerDuration().get(ChronoUnit.MILLIS))+"</MobilityRestrictedTravellerDuration>\n");
		//        #end
		writer.write("      </TransferDuration>\n");
		}
		//      #end
