...
@Slf4j
public class ValidationVehicleJourneysUpdater extends AbstractTestValidation {
	@EJB 
	LineDAO lineDao;
	...
	public static EnterpriseArchive createDeployment() {
		...
		final WebArchive testWar = ShrinkWrap.create(WebArchive.class, "test.war").addAsWebInfResource("postgres-ds.xml")
				...
				.addClass(ValidationVehicleJourneysUpdater.class);
	...
	@Test(groups = { "VehicleJourney" }, description = "2-DATABASE-VehicleJourney-2", priority = 1)
	public void verifyTest2_2() throws Exception {
		// 2-DATABASE-VehicleJourney-2 : check columns
		log.info(Color.BLUE + "2-DATABASE-VehicleJourney-2" + Color.NORMAL);
		...
		copyFile("Ligne_2_Database_VehicleJourney_Company_Test.xml");
		...
		CheckPointReport checkPointReport = validationReport.findCheckPointReportByName("2-DATABASE-VehicleJourney-2");
		Assert.assertNotNull(checkPointReport, "report must contain a 2-DATABASE-VehicleJourney-2 checkPoint");
