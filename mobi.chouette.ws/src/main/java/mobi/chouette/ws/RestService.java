...
public class RestService implements Constant {
    ...
    private static final String api_version_key = "X-ChouetteIEV-Media-Type";
    private static final String api_version = "iev.v1.0; format=json";
    ...
    @GET
    @Path("/{ref}/latest_storage_time")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces({MediaType.TEXT_PLAIN})
    public Response getLatestStorageTime(@PathParam("ref") String referential) {
        try {
    ...
    @GET
    @Path("/{ref}/restoration_storage_time")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces({MediaType.TEXT_PLAIN})
    public Response getStorageTimeFromLastRestoration(@PathParam("ref") String referential) {
        try {
    ...
    @Path("/{ref}/restore")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    public Response restoreReferential(@PathParam("ref") String referential) {
        try {
            storageService.restoreReferential(referential);
