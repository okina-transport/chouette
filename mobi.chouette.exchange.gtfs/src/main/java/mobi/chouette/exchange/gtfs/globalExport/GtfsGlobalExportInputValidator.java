...
@Log4j
public class GtfsGlobalExportInputValidator extends AbstractInputValidator {
	...
	public static class DefaultFactory extends InputValidatorFactory {
		...
		protected InputValidator create() throws IOException {
			InputValidator result = new GtfsGlobalExportInputValidator();
			return result;
		}
	}

	static {
		InputValidatorFactory.factories.put(GtfsGlobalExportInputValidator.class.getName(), new DefaultFactory());
	}
