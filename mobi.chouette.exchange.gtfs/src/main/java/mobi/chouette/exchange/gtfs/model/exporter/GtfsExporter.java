...
public class GtfsExporter implements GtfsExporterInterface {
    ...
    private final Map<String, Exporter<GtfsObject>> _map = new HashMap<String, Exporter<GtfsObject>>();
    ...
    @SuppressWarnings("unchecked")
    public Exporter<GtfsFareAttribute> getFareAttributeExporter() throws GtfsException {
        return getExporter(EXPORTER.FARE_ATTRIBUTE.name(), FareAttributeExporter.FILENAME,
                FareAttributeExporter.class);
    }

    @SuppressWarnings("unchecked")
    public Exporter<GtfsFareRule> getFareRuleExporter() throws GtfsException {
        return getExporter(EXPORTER.FARE_RULE.name(), FareRuleExporter.FILENAME,
                FareRuleExporter.class);
    }
