...
public class TestUtils implements Constant{
	...
	private TestUtils() {
		...
		gtfsTestList.add(new TestDescription(2, GTFS_2_GTFS_Stop_3, "WARNING"));
		...
		gtfsTestList.add(new TestDescription(2, GTFS_2_GTFS_Route_5, "WARNING"));

		gtfsTestList.add(new TestDescription(2, GTFS_3_Route_6, "ERROR"));
	}
