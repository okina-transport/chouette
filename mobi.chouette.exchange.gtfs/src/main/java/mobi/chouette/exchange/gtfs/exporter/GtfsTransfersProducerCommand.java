 ...
 */
@Log4j
public class GtfsTransfersProducerCommand implements Command, Constant {
	public static final String COMMAND = "GtfsTransfersProducerCommand";

	static {
		CommandFactory.factories.put(GtfsTransfersProducerCommand.class.getName(), new DefaultCommandFactory());
	}
	...
	public static class DefaultCommandFactory extends CommandFactory {
		...
		protected Command create(InitialContext context) throws IOException {
			Command result = new GtfsTransfersProducerCommand();
			return result;
		}
	}
