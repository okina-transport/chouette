...
// 		validationReport.setMaxByFile(true);
	...
	public Throwable throwUnknownError(Context context, Exception ex, String filenameInfo) throws Exception {		ActionReporter reporter = ActionReporter.Factory.getInstance();
