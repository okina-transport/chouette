...
public class Phase1FrequencyTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_1_1() throws Exception {
		...
		CheckPointReport result = verifyValidation( log, context, "frequency_1_1", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_1_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_1_2", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_1_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_1_3", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_1_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_1_4", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_2_1", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context,  "frequency_2_2", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_2_3", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_2_4", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_3", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context,  "frequency_4", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_5() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context,  "frequency_5", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context,  "frequency_6", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "frequency_7", GTFS_1_GTFS_Common_11,SEVERITY.WARNING, RESULT.NOK,true);
