...
public class Phase1TripTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_1() throws Exception {
		...
		CheckPointReport result = verifyValidation( log, context, "trip_1", GTFS_1_GTFS_Common_1,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_2_1", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_2_2", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_2_3", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_3_1", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_3_2", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_3_3", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_4", GTFS_1_GTFS_Common_8,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_5() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_5", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_6", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_7", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_8() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_8", GTFS_1_GTFS_Common_11,SEVERITY.WARNING, RESULT.NOK,true);
	...
	public void verifyTest_2_9() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "trip_9", GTFS_1_GTFS_Common_5,SEVERITY.ERROR, RESULT.NOK,true);
