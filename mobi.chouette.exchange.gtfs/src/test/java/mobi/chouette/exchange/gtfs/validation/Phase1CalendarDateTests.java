...
public class Phase1CalendarDateTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_2_1() throws Exception {
		...
		CheckPointReport result = verifyValidation( log, context, "calendar_date_2_1", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_2_2", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_2_3", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_3_1", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_3_2", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_3_3", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_4", GTFS_2_GTFS_Common_3,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_5() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_5", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_6", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_date_7", GTFS_1_GTFS_Common_11,SEVERITY.WARNING, RESULT.NOK,true);
