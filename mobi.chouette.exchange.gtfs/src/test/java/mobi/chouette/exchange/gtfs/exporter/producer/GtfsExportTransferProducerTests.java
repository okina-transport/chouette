...
public class GtfsExportTransferProducerTests {
	...
	public void verifyTransferProducer1() throws ChouetteException {
		...
		Assert.assertEquals(gtfsObject.getTransferType(), GtfsTransfer.TransfersTypeEnum.Minimal, "transfer type must be MINIMAL");
	...
	public void verifyTransferProducer2() throws ChouetteException {
		...
		Assert.assertEquals(gtfsObject.getTransferType(), GtfsTransfer.TransfersTypeEnum.Recommended, "transfer type must be RECOMMENDED");
	...
	public void verifyTransferProducerWithInterchange() throws ChouetteException, IllegalAccessException {
		...
		Assert.assertEquals(gtfsObject.getTransferType(), GtfsTransfer.TransfersTypeEnum.Timed, "transfer type");
