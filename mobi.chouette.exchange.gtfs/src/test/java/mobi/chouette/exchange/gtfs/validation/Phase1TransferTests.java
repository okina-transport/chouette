...
public class Phase1TransferTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_1_1() throws Exception {
		...
		CheckPointReport result = verifyValidation(log, context, "transfer_1_1", GTFS_1_GTFS_Common_9, SEVERITY.ERROR, RESULT.OK, true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation(log, context, "transfer_2_2", GTFS_1_GTFS_Common_12, SEVERITY.ERROR, RESULT.OK, true);
...
//	}
	...
	public void verifyTest_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation(log, context, "transfer_6", GTFS_1_GTFS_Common_11, SEVERITY.WARNING, RESULT.OK, true);
