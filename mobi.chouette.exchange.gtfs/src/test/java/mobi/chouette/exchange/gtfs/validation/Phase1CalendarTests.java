...
public class Phase1CalendarTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_1() throws Exception {
		...
		CheckPointReport result = verifyValidation( log, context, "calendar_1", GTFS_1_GTFS_Common_2,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_1", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_2", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_3", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_4", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_5() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_5", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_6", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_7", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_8() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_8", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_9() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_9", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_2_10() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_2_10", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_1", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_2", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_3", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_4", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_5() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_5", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_6", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_7", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_8() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_8", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_9() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_9", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_3_10() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_3_10", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_4", GTFS_1_GTFS_Common_8,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_5() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_5", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_6", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_7", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_8() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_8", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_9() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context,  "calendar_9", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_10() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_10", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_11() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_11", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_12() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_12", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_13() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_13", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_14() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_14", GTFS_1_GTFS_Common_11,SEVERITY.WARNING, RESULT.NOK,true);
	...
	public void verifyTest_2_15_1() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_15_1", GTFS_1_GTFS_Common_6,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_15_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "calendar_15_2", GTFS_1_GTFS_Common_6,SEVERITY.ERROR, RESULT.NOK,true);
