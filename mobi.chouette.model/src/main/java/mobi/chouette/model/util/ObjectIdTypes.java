...
public interface ObjectIdTypes {
     ...
     */
    public static final String ACCESSIBILITYASSESSMENT_KEY = "AccessibilityAssessment";
    /**
     * default objectId type for access links
     */
    public static final String ACCESSIBILITYLIMITATION_KEY = "AccessibilityLimitation";
     ...
     * default objectId type for timetabled passing times / vehicle journey at stop
     */
    public static final String JOURNEY_FREQUENCY = "JourneyFrequency";
