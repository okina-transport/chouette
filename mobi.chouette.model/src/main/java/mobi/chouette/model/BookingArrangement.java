...
public class BookingArrangement extends NeptuneObject {
	...
	@Getter
	@Setter
	@SequenceGenerator(name = "booking_arrangements_id_seq", sequenceName = "booking_arrangements_id_seq", allocationSize = 100)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "booking_arrangements_id_seq")
	@Id
