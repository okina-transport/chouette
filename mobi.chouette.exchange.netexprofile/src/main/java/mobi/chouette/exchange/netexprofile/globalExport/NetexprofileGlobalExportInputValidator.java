...
@Log4j
public class NetexprofileGlobalExportInputValidator extends AbstractInputValidator {
	...
	public static class DefaultFactory extends InputValidatorFactory {
		...
		protected InputValidator create() throws IOException {
			InputValidator result = new NetexprofileGlobalExportInputValidator();
			return result;
		}
	}

	static {
		InputValidatorFactory.factories.put(NetexprofileGlobalExportInputValidator.class.getName(), new DefaultFactory());
	}
