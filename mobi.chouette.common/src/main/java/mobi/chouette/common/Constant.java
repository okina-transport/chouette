...
public interface Constant {
    ...
    String BRANDING_REF_LINE_MAP = "brandingRefLineMap";
    String BRANDING_REF_SERVICE_JOURNEY_MAP = "brandingRefServiceJourneyMap";
    ...
    String DRIVER_CONTROLLER_CODE = "driver-controller-code";
