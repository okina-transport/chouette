...
--env CHOUETTE_IEV_DB_HOST=192.168.24.59 \
--env CHOUETTE_IEV_DB_PORT=5449 \
--env CHOUETTE_IEV_DB_USER=chouette \
--env CHOUETTE_IEV_DB_PASSWORD=chouette \
--env CHOUETTE_IEV_DB_NAME=iev \
