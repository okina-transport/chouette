...
public class StopAreaService {
     ...
     *
     * @param updateContext Context with all modifications to apply
     */
     ...
     *
     * @param schemaName
     * @return True : schema is still existing
     ...
     *
     * @param updateContext     Context with all modifications that need to be applied.
     * @param currentSchemaName Current schema on which modifications will be applied
     */
     ...
     */
    public void deleteStopAreas(String objectid) {
        ContextHolder.setContext("admin");
        List<String> schemaList = providerDAO.getAllWorkingSchemas();
        ...
        for (String referential : schemaList) {
            ...
            ContextHolder.clear();
            ContextHolder.setContext(referential);
            stopAreaUpdateService.isAStopAreaUsed(objectid);
